...
import com.example.projectapp.databinding.ActivityParentDashboardBinding;
...
public class Parent_Dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.appBarParentDashboard.fab.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.parent__dashboard, menu);
        return true;
    }
