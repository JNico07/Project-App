...
public class DetectorFactory {
    public static YoloV5Classifier getDetector(
        ...
        else if (modelFilename.equals("best-fp16_v1.tflite")) {
            labelFilename = "file:///android_asset/customclasses_v1.txt";
            isQuantized = false;
            inputSize = 416;
            output_width = new int[]{40, 20, 10};
            masks = new int[][]{{0, 1, 2}, {3, 4, 5}, {6, 7, 8}};
        ...
        else if (modelFilename.equals("best-fp16_v2.tflite")) {
            labelFilename = "file:///android_asset/customclasses_v2.txt";
            isQuantized = false;
            inputSize = 416;
            output_width = new int[]{40, 20, 10};
            masks = new int[][]{{0, 1, 2}, {3, 4, 5}, {6, 7, 8}};
        ...
        else if (modelFilename.equals("best-fp16_v3.tflite")) {
            labelFilename = "file:///android_asset/customclasses_v3.txt";
            isQuantized = false;
            inputSize = 640;
            output_width = new int[]{40, 20, 10};
            masks = new int[][]{{0, 1, 2}, {3, 4, 5}, {6, 7, 8}};
