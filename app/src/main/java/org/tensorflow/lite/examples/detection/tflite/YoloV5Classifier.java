...
public class YoloV5Classifier implements Classifier {
    ...
    public static boolean myBooleanValue = false;
...
//        float[][][] outbuf = new float[1][output_box][labels.size() + 5];
        ...
        for (int i = 0; i < output_box; ++i){
            ...
            if (confidenceInClass > getObjThresh()) {
                ...
                // Add a Log statement to print the detected class name
                Log.d("YoloV5Classifier", "Detected Class: " + detectedLabel);

//                // Check if "looking" class is detected
//                if (detectedLabel.equals("eye_looking")) {
//                    myBooleanValue = true;
////                break; // Stop checking once "looking" is detected
////                }
        ...
        // Add this line to print the current value of myBooleanValue to Logcat
        Log.d("YoloV5Classifier", "myBooleanValue: " + myBooleanValue);



        // Update myBooleanValue based on detection result
        myBooleanValue = isLookingDetected;
...
//        final ArrayList<Recognition> recognitions = detections;
    ...
    public static boolean isMyBooleanValue() {
